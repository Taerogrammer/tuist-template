...
public protocol DependencyProvider {
    ...
    static func dataDependency(target: String) -> TargetDependency
    static func dataInterfaceDependency(target: String) -> TargetDependency
}
...
public extension DependencyProvider {
    ...
    static func dataDependency(target: String) -> TargetDependency {
        return .project(
            target: target,
            path: .relativeToData(path: target)
        )
    }
